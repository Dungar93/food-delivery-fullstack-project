...
import { FaUserPlus, FaArrowRight, FaCheckCircle, FaEyeSlash, FaLock, FaUser, FaEye} from "react-icons/fa";
...
<button className= 'w-full py-3 bg-gradient-to-r from-amber-400 to-amber-600 text[#2D1BoE] font-bold rounded-lg flex items-center justify-center gap-2 hover:scale-105 transition-transform'>
  Sign In<FaArrowRight/>
</button>
      </form> 
      <div className= 'text-center'>
        <Link to='/signup' onClick={onClose} className= 'inline-flex items-center gap-2 text-amber-400 hover:text-amber-600 transistion-colors'>
