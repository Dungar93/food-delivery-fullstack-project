...
import FloatingParticles from '../FloatingParticle/FloatingParticle';
import { FaInfoCircle } from 'react-icons/fa'; // Assumed missing import
...
const AboutHome = () => {
  return (
    <div className='min-h-screen bg-gradient-to-br from-[#0f0a0a] via-[#1a1212] to-[#2a1e1e] text-white py-10 sm:py-20 relative overflow-hidden'>
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-8 relative'>
        <div className='w-full order-1 lg:order-2 space-y-8 sm:space-y-12'>
          ...
          <div className='space-y-4 sm:space-y-8'>
            <h2 className='text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-tight'>
              ...
              <br />
              <span className='inline-block mt-2 sm:mt-4 text-2xl sm:text-4xl opacity-90 font-light'>
                Where Flavors Dance &amp; Memories Bloom
              </span>
            </h2>
            <p className='text-base sm:text-xl opacity-90 leading-relaxed max-w-3xl font-serif italic border-l-4 bg-amber-500/90 pl-4 sm:pl-6 py-2 bg-gradient-to-r from-white/20 to-transparent'>
        ...
        <div className='w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0 relative group transform hover:scale-[1.01] transition-all duration-500'>
          <div className='relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber duration-500 shadow-2xl shadow-black/50'>
