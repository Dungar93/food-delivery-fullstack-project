                        ...
                        <div className='mt-12 pt-8 border-t border-amber-800/30 animate-fade-in-up'>
                            <div className='flex flex-col sm:flex-row justify-between items-center gap-8'>
                                ...
                                <div className='flex items-center gap-8'>
                                    ...
                                    <button className='bg-amber-900/40 px-8 py-3 rounded-full font-cinzel uppercase tracking-wider hover:bg-amber-800/50 transition-all duration-300 text-amber-100 inline-flex items-center gap-2 active:scale-95'>
                                        Checkout Now
                                    </button>
                                </div>
                            </div>
