                  ...
                  <div key={_id} className='group bg-amber-900/20 p-4 rounded-2xl border-4 border-dashed border-amber-500 backdrop-blur-sm flex flex-col items-center gap-4 transition-all duration-300 hover:border-solid hover:shadow-xl hover:shadow-amber-900/10 transform hover:-translate-y-1 animate-fade-in'>
                    ...
                    >
                      {imageUrl ? (
                        ...
                        <div className='w-full h-full bg-amber-800 flex items-center justify-center text-amber-200'>No Image</div>
                      )}
                    </div>
                    <div className='w-full text-center'>
                      <h3 className='text-xl font-dancingscript text-amber-100'>{name}</h3>
                      <p className='text-amber-100/80 font-cinzel mt-1'>₹{price.toFixed(2)}</p>
                    </div>
            ...
            <div className='mt-12 pt-8 border-t border-amber-800/30 animate-fade-in-up'>
              <div className='flex flex-col sm:flex-row justify-between items-center gap-8'>
                ...
                <div className='flex items-center gap-8'>
                  ...
                  <Link to='/checkout' className='bg-amber-900/40 px-8 py-3 rounded-full font-cinzel uppercase tracking-wider hover:bg-amber-800/50 transition-all duration-300 text-amber-100 inline-flex items-center gap-2 active:scale-95'>
                    Checkout Now
                  </Link>
                </div>
              </div>
