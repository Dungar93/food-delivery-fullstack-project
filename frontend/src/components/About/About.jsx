...
const About = () => {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-[#1a120b] via-[#3c2a21] to-[#1a120b] text-amber-500
    overflow-hidden relative"
    >
      <div className="absolute inset-0 opacity-10 mix-blend-sorf-light" />
      <motion.section
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        className="py-16 px-4 text-center relative"
      >
        <div className="max-w-a4xl mx-auto">
          <motion.h1
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
          {features.map((f, i) => {
            ...
            return (
              ...
              >
                <div
                  className="absolute -inset-1 bg-gradient-to-br from-amber-600/30 to-amber-500/30
                rounded blur-lg opacity-50 group-hover:opacity-80 transition-opacity duration-500"
                />
