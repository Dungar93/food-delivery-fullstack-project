      ...
      ? [
          {
            name: "My Orders",
            to: "/myorder",
            icon: <FiPackage className="relative top-[1px]" />,
          },
        ]
      : []),
  ];
    ...
    >
        ...
        <div className="flex justify-between items-center h-20 md:h-20~ lg:h-20">
          <div className="flex-shrink-0 flex items-center space-x-2 group relative md:-translate-x-4 lg:-translate-x-6 ml-0 md:ml-22">
            ...
            <div className="flex flex-col relative ml-2 max-w-[140px] md:max-w-[160px] lg:max-w-none">
              <NavLink
                to="/"
                className="text-2xl md:text-xl lg:text-4xl bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text 
          ...
          <div className="hidden md:flex items-center space-x-2 md:space-x-1 lg:space-x-4 flex-1 justify-end mr-7">
            {navLinks.map((link) => (
              ...
              >
                ...
                <span
                  className={`text-amber-100 group-hover:text-amber-300 relative whitespace-nowrap ${
                    link.name === "My Orders"
                      ? "text-sm md:text-sm lg:text-[15px]"
                      : ""
                  }`}
                >
                  {link.name}
                  <span
                    className="absolute -bottom-1 left-0 w-0 h-[2px] bg-amber-400 
            ...
            <div
              className="flex items-center space-x-2 md:space-x-3 lg:space-x-4 ml-3 md:ml-3 lg:ml-6
          mr-2 md:mr-3 lg:mr-4"
            >
              <NavLink
                to="/cart"
                className="p-2 md:p-2.0 lg:p-3 text-amber-100 rounded-xl trabsition-all
            ...
            hover:shadow-lg hover:shadow-amber-500/30 shadow-md shadow-amber-900/20"
              >
                ...
                {totalItems > 0 && (
                  <span
                    className="absolute -top-2 -right-2 bg-amber-600 text-amber-100
          ...
          <div className="px-4 py-4 space-y-2">
            ...
            items-center justify-center space-x-2 text-sm"
              >
                ...
                {totalItems > 0 && (
                  <span
                    className="top-2 right-2 bg-amber-600 text-amber-100
                text-xs w-5 h-5 rounded-full flex items-center justify-center"
                  >
                    {totalItems}
                  </span>
      ...
      {showLoginModal && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div
            className="bg-gradient-to-br from-[#2D1B0E] to-[#4a372a] rounded-xl p-6 w-full
          ...
          >
            ...
            <h2
              className="text-2xl font-bold bg-gradient-to-r from-amber-400 to-amber600
